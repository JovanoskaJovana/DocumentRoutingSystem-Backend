...
public class DocumentRestController {
    ...
    public ResponseEntity<DisplayDocumentDto> createDocument(@RequestPart("data") CreateDocumentDto documentDto,
        ...
        DisplayDocumentDto created = documentService.createDocumentAndDocumentVersion(documentDto, file, employeePrincipal.getEmployeeId());
    ...
    public ResponseEntity<DisplayDocumentDto> routeDocument(@PathVariable Long documentId,
        ...
        DisplayDocumentDto routed = documentService.routeDocument(documentId, employeePrincipal.getEmployeeId());

        return ResponseEntity.status(HttpStatus.OK).body(routed);

    }

    @PreAuthorize("@documentAuth.canSign(#documentId, authentication.principal)")
    @PutMapping("/{documentId}/approve")
    public ResponseEntity<DisplayDocumentDto> approveDocument(@PathVariable Long documentId,
                                                              @AuthenticationPrincipal EmployeePrincipal employeePrincipal) {


        boolean approved = documentService.approveDocument(documentId, employeePrincipal.getEmployeeId());
    ...
    public ResponseEntity<DisplayDocumentDto> rejectDocument(@PathVariable Long documentId,
        ...
        boolean rejected = documentService.rejectDocument(documentId, employeePrincipal.getEmployeeId());
    ...
    public ResponseEntity<DisplayDocumentDto> getDocumentWithVersions(@PathVariable Long documentId) {
        ...
        return ResponseEntity.ok(documentService.findAllWithVersions(documentId));
    }
    ...
    public ResponseEntity<Page<DisplayDocumentDto>> getRoutedToEmployeeInbox(@AuthenticationPrincipal EmployeePrincipal employeePrincipal,
        ...
        Page<DisplayDocumentDto> displayDocumentDto = documentService.findAllByRoutedToEmployee(List.of(DocumentStatus.ROUTED), employeePrincipal.getEmployeeId(), pageable);
    ...
    public ResponseEntity<Page<DisplayDocumentDto>> getRoutedToEmployeeHistory(@AuthenticationPrincipal EmployeePrincipal employeePrincipal,
        ...
        Page<DisplayDocumentDto> displayDocumentDto = documentService.findAllByRoutedToEmployee(List.of(DocumentStatus.APPROVED, DocumentStatus.REJECTED, DocumentStatus.DOWNLOADED), employeePrincipal.getEmployeeId(), pageable);
    ...
    public ResponseEntity<Page<DisplayDocumentDto>> getRoutedToEmployeeDepartment(@AuthenticationPrincipal EmployeePrincipal employeePrincipal,
        ...
        Page<DisplayDocumentDto> documentDto = documentService.findAllByRoutedToDepartment(employeePrincipal.getDepartmentId(), pageable);
